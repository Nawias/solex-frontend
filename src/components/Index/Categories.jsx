...
import { faCar,  faSuitcase, faHome, faBed, faMobile, faTractor, faTshirt, faDog,
    faPaintRoller, faFutbol,faMusic, faRing, faMoneyBillWave,faHandshake, faGuitar, faBabyCarriage
            ...
            <Row className={"my-5 category"} >
                ...
                <Col xs={1} className={"mx-3 p-3 category"}>
                    <Link to={"/szukaj?query=&catId=1"} className={"black-link"} >
                        <div><FAIcon icon={faCar} color={"#eb0000"} size="4x" /></div>
                       <div>Motoryzacja</div>
                    </Link>
                </Col>
